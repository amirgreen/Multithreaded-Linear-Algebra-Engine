...
public class TiredThread extends Thread implements Comparable<TiredThread> {
    ...
    public void run() {
        while (alive.get()){
            try {
                ...
                System.err.println("error at thread '"+ id+"' exception: " + e);
    ...
    public String getReport() {
        return "Worker " + id + " report: \nFatiuge: " + getFatigue() + "\nTime Idle: " + timeIdle.get() + "\nTime Used: " + timeUsed.get()+"\n";
    }

    public synchronized void updateTimeStats(long startTime){
